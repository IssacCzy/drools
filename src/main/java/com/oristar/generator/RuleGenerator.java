...
public class RuleGenerator {
     ...
     *
     * @param ruleDTOs
     * @return 返回生成的 List<drl_str>
     */
    public List<String> generateRules(List<RuleDTO> ruleDTOs) {
